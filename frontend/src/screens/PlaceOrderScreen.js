...
const PlaceOrderScreen = () => {
    ...
    const itemsPrice    = addDecimals(cart.cartItems.reduce((acc, item) => acc + item.price * item.qty, 0)),
          shippingPrice = addDecimals(itemsPrice > 50 ? 0 : 10.00),
                ...
                <Card>
                    <ListGroup variant='flush'>
                        ...
                        <ListGroup.Item>
                            ...
                            <Button type='button' className='btn-block w-100' disabled={cart.cartItems === 0} onClick={placeOrderHandler}>Checkout</Button>
                        </ListGroup.Item>
                    </ListGroup>
                </Card>
            </Col>
