...
export const logout = () => (dispatch) => {
    ...
    // dispatch the action with the constant
...
export const getUserDetails = (id) => async (dispatch, getState) => {
    try {
        ...
        const { userLogin: { userInfo } } = getState() // destructure userInfo from getState (two levels in)
...
export const updateUserProfile = (user) => async (dispatch, getState) => {
    try {
        ...
        localStorage.setItem('userInfo', JSON.stringify(data)) // also update local storage
    } catch (error) {
        dispatch({
...
export const updateUser = (user) => async (dispatch, getState) => {
    try {
        ...
        dispatch({ type: USER_DETAILS_SUCCESS, payload: data }) // pass the updated user to the user details constant to update the state
    } catch (error) {
        dispatch({
